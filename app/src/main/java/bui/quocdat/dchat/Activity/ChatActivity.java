...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        socket.emit("getInfOfUser", userIDFriend).on("resultInfOfUser", args -> runOnUiThread(() -> {
            ...
            try {
                ...
                useName.setText(String.format("%s %s", infUser.getString("first_name"), infUser.getString("last_name")));
...
//        seenMessage(userIDFriend);
        ...
        add_close.setOnClickListener(view -> {
            uriMess = null;
        ...
        socket.on("result_mark", args -> runOnUiThread(() -> readMessage(id, userIDFriend, imageUrl)));
    ...
    private void readMessage(String myId, String userID, final String imageUrl) {
        socket.emit("getMessages", myId, userID).on("resultGetMessages", args -> runOnUiThread(() -> {
    ...
    protected void onResume() {
        ...
        socket.on("messagefromsingle", args -> runOnUiThread(() -> {
